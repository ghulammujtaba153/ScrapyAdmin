...
const CreateBlogModal = ({ isOpen, onClose, onRefresh, showAlert }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            onRefresh();
            onClose();
            showAlert("Success!", "Blog post published successfully.", "success");
        } catch (error) {
            console.error("Error creating blog:", error);
            showAlert("Error", "Failed to publish blog. Please try again.", "error");
        } finally {
            setLoading(false);
        }
    };
